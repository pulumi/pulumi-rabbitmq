...
public final class PermissionsState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<PermissionsPermissionsArgs> permissions;
     ...
     * 
     */
    public Optional<Output<PermissionsPermissionsArgs>> permissions() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder permissions(@Nullable Output<PermissionsPermissionsArgs> permissions) {
