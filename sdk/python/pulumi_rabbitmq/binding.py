...
class BindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination: The destination queue or exchange.
        :param pulumi.Input[builtins.str] destination_type: The type of destination (queue or exchange).
        :param pulumi.Input[builtins.str] source: The source exchange.
        :param pulumi.Input[builtins.str] vhost: The vhost to create the resource in.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] arguments: Additional key/value arguments for the binding.
        :param pulumi.Input[builtins.str] routing_key: A routing key for the binding.
        """
...
class _BindingState:
    def __init__(__self__, *,
                 ...
                 properties_key: Optional[pulumi.Input[builtins.str]] = None,
                 routing_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] destination: The destination queue or exchange.
        :param pulumi.Input[builtins.str] destination_type: The type of destination (queue or exchange).
        :param pulumi.Input[builtins.str] properties_key: A unique key to refer to the binding.
        :param pulumi.Input[builtins.str] routing_key: A routing key for the binding.
        :param pulumi.Input[builtins.str] source: The source exchange.
        :param pulumi.Input[builtins.str] vhost: The vhost to create the resource in.
        """
    ...
    def properties_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def properties_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Binding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            routing_key: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[builtins.str]] = None,
            vhost: Optional[pulumi.Input[builtins.str]] = None) -> 'Binding':
        """
    ...
    @property
    @pulumi.getter(name="argumentsJson")
    def arguments_json(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "arguments_json")
    ...
    @property
    @pulumi.getter(name="propertiesKey")
    def properties_key(self) -> pulumi.Output[builtins.str]:
        """
        A unique key to refer to the binding.
        """
        return pulumi.get(self, "properties_key")
    ...
    @property
    @pulumi.getter(name="routingKey")
    def routing_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A routing key for the binding.
        """
        return pulumi.get(self, "routing_key")
