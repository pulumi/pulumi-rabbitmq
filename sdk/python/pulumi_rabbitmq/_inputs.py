...
class ExchangeSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of exchange.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] arguments: Additional key/value settings for the exchange.
        :param pulumi.Input[builtins.bool] auto_delete: Whether the exchange will self-delete when all
               queues have finished using it.
        :param pulumi.Input[builtins.bool] durable: Whether the exchange survives server restarts.
               Defaults to `false`.
        """
...
if not MYPY:
    class FederationUpstreamDefinitionArgsDict(TypedDict):
        ...
        """
        ack_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        message_ttl: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        prefetch_count: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        reconnect_delay: NotRequired[pulumi.Input[builtins.int]]
        """
        Time in seconds to wait after a network link goes down before attempting reconnection. Default is `5`.
        """
        trust_user_id: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class FederationUpstreamDefinitionArgs:
    def __init__(__self__, *,
                 uri: pulumi.Input[builtins.str],
                 ack_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 message_ttl: Optional[pulumi.Input[builtins.int]] = None,
                 prefetch_count: Optional[pulumi.Input[builtins.int]] = None,
                 queue: Optional[pulumi.Input[builtins.str]] = None,
                 reconnect_delay: Optional[pulumi.Input[builtins.int]] = None,
                 trust_user_id: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] uri: The AMQP URI(s) for the upstream. Note that the URI may contain sensitive information, such as a password.
        :param pulumi.Input[builtins.str] ack_mode: Determines how the link should acknowledge messages. Valid values are `on-confirm`, `on-publish`, and `no-ack`. Default is `on-confirm`.
        :param pulumi.Input[builtins.str] exchange: The name of the upstream exchange.
        :param pulumi.Input[builtins.int] expires: The expiry time (in milliseconds) after which an upstream queue for a federated exchange may be deleted if a connection to the upstream is lost.
        :param pulumi.Input[builtins.int] max_hops: Maximum number of federation links that messages can traverse before being dropped. Default is `1`.
        :param pulumi.Input[builtins.int] message_ttl: The expiry time (in milliseconds) for messages in the upstream queue for a federated exchange (see expires).
               
               Applicable to Federated Queues Only
        :param pulumi.Input[builtins.int] prefetch_count: Maximum number of unacknowledged messages that may be in flight over a federation link at one time. Default is `1000`.
        :param pulumi.Input[builtins.str] queue: The name of the upstream queue.
               
               Consult the RabbitMQ [Federation Reference](https://www.rabbitmq.com/federation-reference.html) documentation for detailed information and guidance on setting these values.
        :param pulumi.Input[builtins.int] reconnect_delay: Time in seconds to wait after a network link goes down before attempting reconnection. Default is `5`.
        :param pulumi.Input[builtins.bool] trust_user_id: Determines how federation should interact with the validated user-id feature. Default is `false`.
    ...
    def ack_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines how the link should acknowledge messages. Valid values are `on-confirm`, `on-publish`, and `no-ack`. Default is `on-confirm`.
        """
    ...
    @ack_mode.setter
    def ack_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def message_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The expiry time (in milliseconds) for messages in the upstream queue for a federated exchange (see expires).
    ...
    @message_ttl.setter
    def message_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "message_ttl", value)

    @property
    @pulumi.getter(name="prefetchCount")
    def prefetch_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum number of unacknowledged messages that may be in flight over a federation link at one time. Default is `1000`.
        """
    ...
    def prefetch_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def reconnect_delay(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Time in seconds to wait after a network link goes down before attempting reconnection. Default is `5`.
        """
    ...
    def reconnect_delay(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "reconnect_delay", value)

    @property
    @pulumi.getter(name="trustUserId")
    def trust_user_id(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Determines how federation should interact with the validated user-id feature. Default is `false`.
    ...
    def trust_user_id(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "trust_user_id", value)


if not MYPY:
    class OperatorPolicyPolicyArgsDict(TypedDict):
        apply_to: pulumi.Input[builtins.str]
        """
        Can be "queues".
        """
        definition: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]
        """
...
class OperatorPolicyPolicyArgs:
    def __init__(__self__, *,
                 ...
                 priority: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] apply_to: Can be "queues".
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] definition: Key/value pairs of the operator policy definition. See the
               RabbitMQ documentation for definition references and examples.
        :param pulumi.Input[builtins.str] pattern: A pattern to match an exchange or queue name.
        :param pulumi.Input[builtins.int] priority: The policy with the greater priority is applied first.
        """
    ...
    def apply_to(self) -> pulumi.Input[builtins.str]:
        """
        Can be "queues".
        """
    ...
    @apply_to.setter
    def apply_to(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "apply_to", value)

    @property
    @pulumi.getter
    def definition(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
        Key/value pairs of the operator policy definition. See the
        RabbitMQ documentation for definition references and examples.
        """
    ...
    @definition.setter
    def definition(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
class PermissionsPermissionsArgs:
    def __init__(__self__, *,
                 ...
                 write: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] configure: The "configure" ACL.
        :param pulumi.Input[builtins.str] read: The "read" ACL.
        :param pulumi.Input[builtins.str] write: The "write" ACL.
        """
...
class PolicyPolicyArgs:
    def __init__(__self__, *,
                 ...
                 priority: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] apply_to: Can either be "exchanges", "queues", or "all".
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] definition: Key/value pairs of the policy definition. See the
               RabbitMQ documentation for definition references and examples.
        :param pulumi.Input[builtins.str] pattern: A pattern to match an exchange or queue name.
        :param pulumi.Input[builtins.int] priority: The policy with the greater priority is applied first.
        """
...
if not MYPY:
    class QueueSettingsArgsDict(TypedDict):
        ...
        """
        arguments_json: NotRequired[pulumi.Input[builtins.str]]
        """
...
class QueueSettingsArgs:
    def __init__(__self__, *,
                 arguments: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 arguments_json: Optional[pulumi.Input[builtins.str]] = None,
                 auto_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 durable: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] arguments: Additional key/value settings for the queue.
               All values will be sent to RabbitMQ as a string. If you require non-string
               values, use `arguments_json`.
        :param pulumi.Input[builtins.str] arguments_json: A nested JSON string which contains additional
               settings for the queue. This is useful for when the arguments contain
               non-string values.
        :param pulumi.Input[builtins.bool] auto_delete: Whether the queue will self-delete when all
               consumers have unsubscribed.
        :param pulumi.Input[builtins.bool] durable: Whether the queue survives server restarts.
               Defaults to `false`.
        """
        if arguments is not None:
            pulumi.set(__self__, "arguments", arguments)
    ...
    def arguments_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A nested JSON string which contains additional
        settings for the queue. This is useful for when the arguments contain
        non-string values.
    ...
    def arguments_json(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ShovelInfoArgsDict(TypedDict):
        destination_uri: pulumi.Input[builtins.str]
        """
        ...
        """
        add_forward_headers: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to add `x-shovelled` headers to shovelled messages.
        """
        delete_after: NotRequired[pulumi.Input[builtins.str]]
        """
        Determines when (if ever) the shovel should delete itself. Possible values are: `never`, `queue-length` or an integer.
        """
        destination_add_forward_headers: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to add `x-shovelled` headers to shovelled messages.
        """
        destination_add_timestamp_header: NotRequired[pulumi.Input[builtins.bool]]
        destination_address: NotRequired[pulumi.Input[builtins.str]]
        """
        The AMQP 1.0 destination link address.
        """
        destination_application_properties: NotRequired[pulumi.Input[builtins.str]]
        """
        Application properties to set when shovelling messages.
        """
        destination_exchange: NotRequired[pulumi.Input[builtins.str]]
        """
        The exchange to which messages should be published.
        Either this or `destination_queue` must be specified but not both.
        """
        destination_exchange_key: NotRequired[pulumi.Input[builtins.str]]
        """
        The routing key when using `destination_exchange`.
        """
        destination_properties: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        destination_protocol: NotRequired[pulumi.Input[builtins.str]]
        """
        The protocol (`amqp091` or `amqp10`) to use when connecting to the destination.
        Defaults to `amqp091`.
        """
        destination_publish_properties: NotRequired[pulumi.Input[builtins.str]]
        """
        A map of properties to overwrite when shovelling messages.
        """
        destination_queue: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        source_delete_after: NotRequired[pulumi.Input[builtins.str]]
        """
        Determines when (if ever) the shovel should delete itself. Possible values are: `never`, `queue-length` or an integer.
        """
        source_exchange: NotRequired[pulumi.Input[builtins.str]]
        """
        The exchange from which to consume.
        Either this or `source_queue` must be specified but not both.
        """
        source_exchange_key: NotRequired[pulumi.Input[builtins.str]]
        """
        The routing key when using `source_exchange`.
        """
        source_prefetch_count: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum number of unacknowledged messages copied over a shovel at any one time.
        """
        source_protocol: NotRequired[pulumi.Input[builtins.str]]
        """
        The protocol (`amqp091` or `amqp10`) to use when connecting to the source.
        Defaults to `amqp091`.
        """
        source_queue: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ShovelInfoArgs:
    def __init__(__self__, *,
                 ...
                 source_uri: pulumi.Input[builtins.str],
                 ack_mode: Optional[pulumi.Input[builtins.str]] = None,
                 add_forward_headers: Optional[pulumi.Input[builtins.bool]] = None,
                 delete_after: Optional[pulumi.Input[builtins.str]] = None,
                 destination_add_forward_headers: Optional[pulumi.Input[builtins.bool]] = None,
                 destination_add_timestamp_header: Optional[pulumi.Input[builtins.bool]] = None,
                 destination_address: Optional[pulumi.Input[builtins.str]] = None,
                 destination_application_properties: Optional[pulumi.Input[builtins.str]] = None,
                 destination_exchange: Optional[pulumi.Input[builtins.str]] = None,
                 destination_exchange_key: Optional[pulumi.Input[builtins.str]] = None,
                 destination_properties: Optional[pulumi.Input[builtins.str]] = None,
                 destination_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 destination_publish_properties: Optional[pulumi.Input[builtins.str]] = None,
                 destination_queue: Optional[pulumi.Input[builtins.str]] = None,
                 prefetch_count: Optional[pulumi.Input[builtins.int]] = None,
                 reconnect_delay: Optional[pulumi.Input[builtins.int]] = None,
                 source_address: Optional[pulumi.Input[builtins.str]] = None,
                 source_delete_after: Optional[pulumi.Input[builtins.str]] = None,
                 source_exchange: Optional[pulumi.Input[builtins.str]] = None,
                 source_exchange_key: Optional[pulumi.Input[builtins.str]] = None,
                 source_prefetch_count: Optional[pulumi.Input[builtins.int]] = None,
                 source_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 source_queue: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] destination_uri: The amqp uri for the destination .
        :param pulumi.Input[builtins.str] source_uri: The amqp uri for the source.
        :param pulumi.Input[builtins.str] ack_mode: Determines how the shovel should acknowledge messages. Possible values are: `on-confirm`, `on-publish` and `no-ack`.
               Defaults to `on-confirm`.
        :param pulumi.Input[builtins.bool] add_forward_headers: Whether to add `x-shovelled` headers to shovelled messages.
        :param pulumi.Input[builtins.str] delete_after: Determines when (if ever) the shovel should delete itself. Possible values are: `never`, `queue-length` or an integer.
        :param pulumi.Input[builtins.bool] destination_add_forward_headers: Whether to add `x-shovelled` headers to shovelled messages.
        :param pulumi.Input[builtins.str] destination_address: The AMQP 1.0 destination link address.
        :param pulumi.Input[builtins.str] destination_application_properties: Application properties to set when shovelling messages.
        :param pulumi.Input[builtins.str] destination_exchange: The exchange to which messages should be published.
               Either this or `destination_queue` must be specified but not both.
        :param pulumi.Input[builtins.str] destination_exchange_key: The routing key when using `destination_exchange`.
        :param pulumi.Input[builtins.str] destination_properties: Properties to overwrite when shovelling messages.
               
               For more details regarding dynamic shovel parameters please have a look at the official reference documentaion at [RabbitMQ: Configuring Dynamic Shovels](https://www.rabbitmq.com/shovel-dynamic.html).
        :param pulumi.Input[builtins.str] destination_protocol: The protocol (`amqp091` or `amqp10`) to use when connecting to the destination.
               Defaults to `amqp091`.
        :param pulumi.Input[builtins.str] destination_publish_properties: A map of properties to overwrite when shovelling messages.
        :param pulumi.Input[builtins.str] destination_queue: The queue to which messages should be published.
               Either this or `destination_exchange` must be specified but not both.
        :param pulumi.Input[builtins.int] prefetch_count: The maximum number of unacknowledged messages copied over a shovel at any one time.
        :param pulumi.Input[builtins.int] reconnect_delay: The duration in seconds to reconnect to a broker after disconnected.
               Defaults to `1`.
        :param pulumi.Input[builtins.str] source_address: The AMQP 1.0 source link address.
        :param pulumi.Input[builtins.str] source_delete_after: Determines when (if ever) the shovel should delete itself. Possible values are: `never`, `queue-length` or an integer.
        :param pulumi.Input[builtins.str] source_exchange: The exchange from which to consume.
               Either this or `source_queue` must be specified but not both.
        :param pulumi.Input[builtins.str] source_exchange_key: The routing key when using `source_exchange`.
        :param pulumi.Input[builtins.int] source_prefetch_count: The maximum number of unacknowledged messages copied over a shovel at any one time.
        :param pulumi.Input[builtins.str] source_protocol: The protocol (`amqp091` or `amqp10`) to use when connecting to the source.
               Defaults to `amqp091`.
        :param pulumi.Input[builtins.str] source_queue: The queue from which to consume.
               Either this or `source_exchange` must be specified but not both.
        """
    ...
    def destination_uri(self) -> pulumi.Input[builtins.str]:
        """
        The amqp uri for the destination .
        """
    ...
    def destination_uri(self, value: pulumi.Input[builtins.str]):
    ...
    def add_forward_headers(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to add `x-shovelled` headers to shovelled messages.
        """
    ...
    def add_forward_headers(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def delete_after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines when (if ever) the shovel should delete itself. Possible values are: `never`, `queue-length` or an integer.
        """
    ...
    @delete_after.setter
    def delete_after(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delete_after", value)

    @property
    @pulumi.getter(name="destinationAddForwardHeaders")
    def destination_add_forward_headers(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to add `x-shovelled` headers to shovelled messages.
        """
    ...
    def destination_add_forward_headers(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "destination_add_forward_headers", value)

    @property
    @pulumi.getter(name="destinationAddTimestampHeader")
    def destination_add_timestamp_header(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "destination_add_timestamp_header")

    @destination_add_timestamp_header.setter
    def destination_add_timestamp_header(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def destination_application_properties(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Application properties to set when shovelling messages.
        """
    ...
    def destination_application_properties(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_application_properties", value)

    @property
    @pulumi.getter(name="destinationExchange")
    def destination_exchange(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The exchange to which messages should be published.
        Either this or `destination_queue` must be specified but not both.
        """
    ...
    def destination_exchange(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_exchange", value)

    @property
    @pulumi.getter(name="destinationExchangeKey")
    def destination_exchange_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The routing key when using `destination_exchange`.
        """
    ...
    def destination_exchange_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_exchange_key", value)

    @property
    @pulumi.getter(name="destinationProperties")
    def destination_properties(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Properties to overwrite when shovelling messages.
    ...
    def destination_properties(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_properties", value)

    @property
    @pulumi.getter(name="destinationProtocol")
    def destination_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The protocol (`amqp091` or `amqp10`) to use when connecting to the destination.
        Defaults to `amqp091`.
        """
    ...
    def destination_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_protocol", value)

    @property
    @pulumi.getter(name="destinationPublishProperties")
    def destination_publish_properties(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A map of properties to overwrite when shovelling messages.
        """
    ...
    def destination_publish_properties(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_publish_properties", value)

    @property
    @pulumi.getter(name="destinationQueue")
    def destination_queue(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The queue to which messages should be published.
        Either this or `destination_exchange` must be specified but not both.
        """
    ...
    def destination_queue(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_delete_after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines when (if ever) the shovel should delete itself. Possible values are: `never`, `queue-length` or an integer.
        """
    ...
    def source_delete_after(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_exchange_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The routing key when using `source_exchange`.
        """
    ...
    def source_exchange_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_exchange_key", value)

    @property
    @pulumi.getter(name="sourcePrefetchCount")
    def source_prefetch_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of unacknowledged messages copied over a shovel at any one time.
        """
    ...
    def source_prefetch_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "source_prefetch_count", value)

    @property
    @pulumi.getter(name="sourceProtocol")
    def source_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The protocol (`amqp091` or `amqp10`) to use when connecting to the source.
        Defaults to `amqp091`.
        """
    ...
    def source_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_protocol", value)

    @property
    @pulumi.getter(name="sourceQueue")
    def source_queue(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The queue from which to consume.
        Either this or `source_exchange` must be specified but not both.
        """
    ...
    @source_queue.setter
    def source_queue(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TopicPermissionsPermissionArgs:
    def __init__(__self__, *,
                 ...
                 write: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] exchange: The exchange to set the permissions for.
        :param pulumi.Input[builtins.str] read: The "read" ACL.
        :param pulumi.Input[builtins.str] write: The "write" ACL.
        """
        pulumi.set(__self__, "exchange", exchange)
