...
class FederationUpstreamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the federation upstream.
        """
...
class _FederationUpstreamState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] component: Set to `federation-upstream` by the underlying RabbitMQ provider. You do not set this attribute but will see it in state and plan output.
        :param pulumi.Input['FederationUpstreamDefinitionArgs'] definition: The configuration of the federation upstream. The structure is described below.
        :param pulumi.Input[builtins.str] name: The name of the federation upstream.
        :param pulumi.Input[builtins.str] vhost: The vhost to create the resource in.
        """
...
@pulumi.type_token("rabbitmq:index/federationUpstream:FederationUpstream")
class FederationUpstream(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            definition: Optional[pulumi.Input[Union['FederationUpstreamDefinitionArgs', 'FederationUpstreamDefinitionArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            vhost: Optional[pulumi.Input[builtins.str]] = None) -> 'FederationUpstream':
        """
    ...
    @property
    @pulumi.getter
    def component(self) -> pulumi.Output[builtins.str]:
        """
        Set to `federation-upstream` by the underlying RabbitMQ provider. You do not set this attribute but will see it in state and plan output.
        """
        return pulumi.get(self, "component")
