...
replace (
	...
	github.com/terraform-providers/terraform-provider-rabbitmq => github.com/cyrilgdn/terraform-provider-rabbitmq v1.7.0
)
...
require (
	...
	github.com/michaelklishin/rabbit-hole/v2 v2.10.0 // indirect
